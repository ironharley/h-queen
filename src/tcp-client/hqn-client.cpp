...
int main(int argc, char* argv[]) {
    try {
        ...
        ctx.load_verify_file("../hqn-proto/etc/ssl/rootCA.pem");

        ctx.use_certificate_chain_file("../hqn-proto/etc/ssl/client.pem");
        ctx.use_private_key_file("../hqn-proto/etc/ssl/client.key", boost::asio::ssl::context::pem);
        //ctx.use_tmp_dh_file("../hqn-proto/etc/ssl/dh2048.pem");
